...
/** Banda oscura a sangre completa: sin card, ocupa el 100% del ancho. */
export default function AISection() {
  return (
    <section className="section theme-dark ai" id="ia">
      <div className="tech-grid" />
      <motion.div
        className="aurora aurora--teal"
        style={{ width: 520, height: 520, left: '8%', bottom: '-34%' }}
        animate={{ x: [0, 70, 0], y: [0, -34, 0] }}
        transition={{ duration: 24, repeat: Infinity, ease: 'easeInOut' }}
      />

      <div className="container container--wide ai__inner">
        <div>
