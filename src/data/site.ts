...
export const NEWS: NewsItem[] = [
  {
    ...
    color: '#0f8a5f',
    title: 'LINKDICOM patrocina al equipo de sóftbol La Esquinita de Yaguate, campeón del torneo',
    excerpt:
    ...
    image: '/img/noticias/softball-equipo.webp',
  ...
  },
  {
    ...
    category: 'Responsabilidad Social',
    color: '#0f8a5f',
    title: 'LINKDICOM co-patrocina el 5.º evento RODAMONTESSJ “Rodando por la Restauración”',
    excerpt:
    ...
    image: '/img/noticias/rodamontes-equipo.webp',
  ...
  },
  {
    ...
    image: '/img/noticias/nelson-astacio.webp',
  ...
  },
  {
    ...
    category: 'Innovación',
    color: '#6d5bd0',
    title: 'LINKDICOM presenta RadioloGOx Beta, la nueva generación de su plataforma PACS-RIS',
    excerpt:
      'Conserva la estabilidad de RadioloGOx Pro e incorpora una arquitectura moderna y nuevas herramientas de visualización diagnóstica.',
    image: '/img/noticias/radiologox-beta.webp',
